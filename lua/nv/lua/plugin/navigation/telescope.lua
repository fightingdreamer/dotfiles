...
return {
  ...
  keys = {
    ...
    { "<leader>ld", "<cmd>Telescope lsp_definitions reuse_win=true<cr>", desc = "telescope lsp definitions" },
    { "<leader>lt", "<cmd>Telescope lsp_type_definitions reuse_win=true<cr>", desc = "telescope type definitions" },
